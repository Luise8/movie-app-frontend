...
export default function SignUp() {
  ...
  return (
    <PageLayout>
      <Container className="page" data-testid="page-sign-up">
        ...
        <Box component="form" className="page-form" data-testid="page-sign-up-form">
          <TextField
            required
            fullWidth
            id="username"
          ...
          <Collapse in={Boolean(error?.message)}>
            <Alert
              ...
              data-testid="page-sign-up-alert"
              action={(
                <IconButton
                  aria-label="close"
                  color="inherit"
        ...
        <ModalNotification title="Successfully created" body="Account successfully created" handleClose={handleCloseIsSaved} open={isSaved} />
      </Container>
    </PageLayout>
  );
}
